...
fn main() {
    generate(
        "../machinery-sys/src/foundation.rs",
        "./src/generated/foundation.rs",
        "foundation",
    );
    generate(
        "../machinery-sys/src/plugins/entity.rs",
        "./src/generated/plugins/entity.rs",
        "plugins::entity",
    );
}

fn generate(input: &str, output: &str, module: &str) {
    ...
    src.push_str("use machinery_sys::");
    src.push_str(module);
    src.push_str("::*;\n\n");
